...
import ScrollToTopOnMount from "../../template/ScrollToToOnMount";
      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            ...
            <h4 className="text-muted mb-4">1000 Rs</h4>
            ...
            <div className="row g-3 mb-4">
              <div className="col">
                ...
                to={"/cart"}
                state={{name: "Nillkin iPhone X cover", price: 1000,quantity: 1}}>
                  Add to Cart
                </Link>
              </div>
              <div className="col">
